...
#ifndef DSPLIB_add_IXX_IXX_OXX_IDAT_H

#define DSPLIB_add_IXX_IXX_OXX_IDAT_H
...
typedef struct {
   ...
   uint32_t numReps;
   uint32_t testID;
} DSPLIB_add_testParams_t;

void DSPLIB_add_getTestParams(DSPLIB_add_testParams_t **params, int32_t *numTests);

#endif /* define DSPLIB_add_IXX_IXX_OXX_IDAT_H */

/* ======================================================================== */
/*  End of file:  DSPLIB_addtestParams.h                                     */
/* ======================================================================== */
