...
#ifndef DSPLIB_bexp_IXX_IXX_OXX_IDAT_H

#define DSPLIB_bexp_IXX_IXX_OXX_IDAT_H
...
typedef struct {
   uint8_t  testPattern; /* 0: consbexpt, 1: sequential, 2: random, 3: static array, 4: file, etc */
   void    *staticIn;
   void    *staticOut;
   uint32_t dataType;
   uint32_t dataSize;
...
#endif /* define DSPLIB_bexp_IXX_IXX_OXX_IDAT_H */

/* ======================================================================== */
/*  End of file:  DSPLIB_bexp_idat.h                                     */
/* ======================================================================== */
