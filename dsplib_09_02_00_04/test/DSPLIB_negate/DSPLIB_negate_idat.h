...
#ifndef DSPLIB_negate_IXX_IXX_OXX_IDAT_H

#define DSPLIB_negate_IXX_IXX_OXX_IDAT_H
...
typedef struct {
   uint8_t testPattern; /* 0: conssqrAddt, 1: sequential, 2: random, 3: static
                           array, 4: file, etc */
   void    *staticIn;
   void    *staticOut;
   uint32_t dataTypeIn;
...
#endif /* define DSPLIB_negate_IXX_IXX_OXX_IDAT_H */

/* ======================================================================== */
/*  End of file:  DSPLIB_negatetestParams.h */
/* ======================================================================== */
