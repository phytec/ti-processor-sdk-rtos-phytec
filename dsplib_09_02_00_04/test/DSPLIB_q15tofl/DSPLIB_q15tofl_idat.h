...
#ifndef DSPLIB_Q15TOFL_IXX_IXX_OXX_IDAT_H

#define DSPLIB_Q15TOFL_IXX_IXX_OXX_IDAT_H
...
typedef struct {
   ...
   uint32_t numReps;
   uint32_t testID;
} q15tofl_testParams_t;

void q15tofl_getTestParams(q15tofl_testParams_t **params, int32_t *numTests);

#endif /* define DSPLIB_Q15TOFL_IXX_IXX_OXX_IDAT_H */

/* ======================================================================== */
/*  End of file:  DSPLIB_q15tofl_idat.h                                     */
/* ======================================================================== */
