...
def gen_idat_file(idatFile, testCases, testIdList):
    ...
    includeString = '#include "DSPLIB_dotprod_idat.h"'
    ...
    idatFile.write("static DSPLIB_dotprod_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    if dTypeOut == "int16_t":
        out = sum((in0.astype("int16") * in1.astype("int16")))
    elif dTypeOut == "int32_t":
        out = sum((in0.astype("int32") * in1.astype("int32")))
    elif dTypeOut == "int64_t":
        out = sum((in0.astype("int64") * in1.astype("int64")))
    elif dTypeOut == "uint16_t":
        out = sum((in0.astype("uint16") * in1.astype("uint16")))
    elif dTypeOut == "uint32_t":
        out = sum((in0.astype("uint32") * in1.astype("uint32")))
...
idatFileName = "../../DSPLIB_dotprod/DSPLIB_dotprod_idat.c"
