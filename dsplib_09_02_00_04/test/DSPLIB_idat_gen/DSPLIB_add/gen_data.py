...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "DSPLIB_add_idat.h"'
    ...
    idatFile.write("static DSPLIB_add_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    if dTypeIn0 == "int8_t":
        ...
        in0 = np.random.uniform(low=-10, high=10, size=(length,)).astype("float")
        in1 = np.random.uniform(low=-10, high=10, size=(length,)).astype("float")
    elif dTypeIn0 == "double":
        in0 = np.random.uniform(low=-10, high=10, size=(length,)).astype("double")
        in1 = np.random.uniform(low=-10, high=10, size=(length,)).astype("double")
...
idatFileName = "../../DSPLIB_add/DSPLIB_add_idat.c"
