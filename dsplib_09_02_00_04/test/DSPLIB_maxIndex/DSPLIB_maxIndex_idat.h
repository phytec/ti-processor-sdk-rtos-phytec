...
#ifndef DSPLIB_MAXINDEX_IXX_IXX_OXX_IDAT_H

#define DSPLIB_MAXINDEX_IXX_IXX_OXX_IDAT_H
...
typedef struct {
   ...
   uint32_t  numReps;
   uint32_t  testID;
} maxIndex_testParams_t;

void maxIndex_getTestParams(maxIndex_testParams_t **params, int32_t *numTests);

#endif /* define DSPLIB_MAXINDEX_IXX_IXX_OXX_IDAT_H */

/* ======================================================================== */
/*  End of file:  DSPLIB_maxIndex_idat.h                                    */
/* ======================================================================== */