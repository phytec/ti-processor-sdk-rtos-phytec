...
/********************************************************************************
 *  @file     DSPLIB_matMul_priv.h
 *
 *  @brief    File to hold private parameter of function DSPLIB_matMul
 *
 *  @version  0.1 - Mar 2022 : Initial Version
 *
 ********************************************************************************/

#ifndef DSPLIB_MATMUL_IXX_IXX_OXX_PRIV_H_
#define DSPLIB_MATMUL_IXX_IXX_OXX_PRIV_H_

#include "../common/DSPLIB_utility.h"
#include "DSPLIB_matMul.h"

/*!
 * \file
 * \brief Header file for kernel's internal use. For the kernel's interface,
 * please see @ref DSPLIB_matMul
 */

/*!
 * @brief Macro to define the size of bufPblock array of
 *        @ref DSPLIB_matMul_PrivArgs structure.
 *
 */

#define DSPLIB_MATMUL_IXX_IXX_OXX_PBLOCK_SIZE (5 * SE_PARAM_SIZE)
 ...
 *         declaration of @ref DSPLIB_matMul_exec_ci
 *         and @ref DSPLIB_matMul_exec_cn.
 */
typedef DSPLIB_STATUS (*pFxnDSPLIB_matMul_exec)(DSPLIB_kernelHandle handle,
                                                void *restrict pIn1,
                                                void *restrict pIn2,
                                                void *restrict pOut);
 ...
 *         to the declaration of @ref DSPLIB_matMul_init.
 *
 * @details This function determines the configuration for the streaming engine
 *          and MMA hardware resources based on the function call parameters,
 *          and the configuration is saved in bufPBlock array. In the kernel
 *          call sequence, @ref DSPLIB_matMul_exec_ci would be
 *          called later independently by the application. When
 *          @ref DSPLIB_matMul_exec_ci runs, it merely retrieves
 *          the configuration from the bufPBlock and uses it to set up the
 *          hardware resources. This arrangement is so that
 *          @ref DSPLIB_matMul_exec_ci does not lose cycles
 ...
 *         implementation of the kernel. The function declaration conforms
 *         to the declaration of @ref DSPLIB_matMul_exec.
 *
...
template <typename dataType>
DSPLIB_STATUS
DSPLIB_matMul_exec_ci(DSPLIB_kernelHandle handle, void *restrict pIn1, void *restrict pIn2, void *restrict pOut);
...
DSPLIB_matMul_exec_cn(DSPLIB_kernelHandle handle, void *restrict pIn1, void *restrict pIn2, void *restrict pOut);
...
typedef struct {
    ...
    *         @ref DSPLIB_matMul_exec_cn and
    *         @ref DSPLIB_matMul_exec_ci.                        */
 ...
 */
DSPLIB_STATUS
DSPLIB_matMul_init_cn(DSPLIB_kernelHandle   handle,
...
#endif /* DSPLIB_MATMUL_IXX_IXX_OXX_PRIV_H_ */

/* ======================================================================== */
/*  End of file:  DSPLIB_matMul.h          */
/* ======================================================================== */
