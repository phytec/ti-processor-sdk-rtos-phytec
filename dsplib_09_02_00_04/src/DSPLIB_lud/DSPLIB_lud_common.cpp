...
void DSPLIB_lud_identity_matrix_generate_init_ci(uint8_t *pBlock, int32_t order, int32_t stride)
{
   ...
   sa0Params.DECDIM1_WIDTH = order * colStride;
...
template void
DSPLIB_lud_identity_matrix_generate_init_ci<unsigned short>(uint8_t *pBlock, int32_t order, int32_t stride);
template <typename dataType>
                                             ...
                                             uint8_t *pBlock)
{
   ...
   int32_t K         = nColsIn0;
   int32_t N         = nColsIn1;
   int32_t colStrideIn0 = (strideIn0) ;
   int32_t colStrideIn1 = (strideIn1) ;
   int32_t colStrideOut = (strideOut) ;
                                    ...
                                    uint8_t *pBlock)
{
   ...
   se0Params.DIM2          = DSPLIB_MATMUL_GEN_UNROLL_FACTOR * (int32_t)((uint32_t)(strideIn1) << (uint32_t) 1);
   ...
   se1Params.DIM2          = DSPLIB_MATMUL_GEN_UNROLL_FACTOR *(int32_t)((uint32_t)(strideIn1) << (uint32_t) 1);
   ...
   *(__SE_TEMPLATE_v1 *) ((uint8_t *) pBlock)                       = se0Params;
   *(__SE_TEMPLATE_v1 *) ((uint8_t *) pBlock + (1 * SE_PARAM_SIZE)) = se1Params;
...
void DSPLIB_lud_identity_matrix_generate_exec_ci(dataType *pMat, int32_t order, int32_t colStride, uint8_t *pBlock)
{
   ...
   for (int32_t block = 0; block < order; block++) {
   ...
   sa1Params.ICNT0 = 1;
   sa1Params.ICNT1 = order / 2;
   sa1Params.DIM1  = 2 * (colStride + 1);

   sa0Params.ICNT0 = 1;
   sa0Params.ICNT1 = order - sa1Params.ICNT1;
   sa0Params.DIM1  = 2 * (colStride + 1);
   __SA0_OPEN(sa0Params);
   if (sa1Params.ICNT1 != 0) {
      __SA1_OPEN(sa1Params);
   }
   for (int32_t diag = 0; diag < order; diag += 2) {
...
template void
DSPLIB_lud_identity_matrix_generate_exec_ci<float>(float *pMat, int32_t order, int32_t colStride, uint8_t *pBlock);
template void
              DSPLIB_lud_identity_matrix_generate_exec_ci<double>(double *pMat, int32_t order, int32_t colStride, uint8_t *pBlock);
...
template <typename dataType>
DSPLIB_STATUS DSPLIB_matMul_N_unroll_exec_ci(int32_t           nRowsIn0,
                                            int32_t            nColsIn0,
                                            int32_t            nColsIn1,
                                            int32_t            strideIn1,
...
template DSPLIB_STATUS DSPLIB_matMul_N_unroll_exec_ci<float>(int32_t          nRowsIn0,
                                                             int32_t          nColsIn0,
                                                             int32_t          nColsIn1,
                                                             int32_t          strideIn1,
                                                             float *restrict  pIn0,
...
template DSPLIB_STATUS DSPLIB_matMul_N_unroll_exec_ci<double>(int32_t          nRowsIn0,
                                                              int32_t          nColsIn0,
                                                              int32_t          nColsIn1,
                                                              int32_t          strideIn1,
                                                              double *restrict pIn0,
...
template <typename dataType>
DSPLIB_STATUS DSPLIB_matMul_generic_exec_ci(int32_t            nRowsIn0,
                                            int32_t            nColsIn0,
                                            int32_t            nColsIn1,
                                            int32_t            strideIn1,
                                            dataType *restrict pIn0,
                                            ...
                                            uint8_t *          pBlock)
{
   ...
   int32_t M = nRowsIn0; // row of in0
   int32_t K = nColsIn0; // col of in0 and row of in1
   int32_t N = nColsIn1; // col of in1
...
template DSPLIB_STATUS DSPLIB_matMul_generic_exec_ci<float>(int32_t          nRowsIn0,
                                                            int32_t          nColsIn0,
                                                            int32_t          nColsIn1,
                                                            int32_t          strideIn1,
                                                            float *restrict  pIn0,
                                                            ...
                                                            float *restrict  pOut,
                                                            uint8_t *        pBlock);
template DSPLIB_STATUS DSPLIB_matMul_generic_exec_ci<double>(int32_t          nRowsIn0,
                                                             int32_t          nColsIn0,
                                                             int32_t          nColsIn1,
                                                             int32_t          strideIn1,
                                                             double *restrict pIn0,
                                    ...
                                    uint8_t *          pBlock)
{
   DSPLIB_DEBUGPRINTFN(0, "%s\n", "Entering function");
   if (nColsIn1 % DSPLIB_MATMUL_UNROLL == 0) {
      DSPLIB_matMul_N_unroll_exec_ci<dataType>(nRowsIn0, nColsIn0, nColsIn1, strideIn1, pIn0, pIn1, pOut,  pBlock);
   }
   else {
      DSPLIB_matMul_generic_exec_ci<dataType>(nRowsIn0, nColsIn0, nColsIn1, strideIn1, pIn0, pIn1, pOut, pBlock);
   }
   DSPLIB_DEBUGPRINTFN(0, "Exiting function with return status: %d\n", DSPLIB_SUCCESS);
  return DSPLIB_SUCCESS;
}

template DSPLIB_STATUS DSPLIB_matMul_exec_ci<float>(int32_t          nRowsIn0,
                                                    int32_t          nColsIn0,
                                                    int32_t          nColsIn1,
                                                    int32_t          strideIn1,
                                                    float *restrict pIn0,
                                                    ...
                                                    float *restrict pOut,
                                                    uint8_t *        pBlock);
template DSPLIB_STATUS DSPLIB_matMul_exec_ci<double>(int32_t          nRowsIn0,
                                                     int32_t          nColsIn0,
                                                     int32_t          nColsIn1,
                                                     int32_t          strideIn1,
                                                     double *restrict pIn0,
...
template <typename dataType> void DSPLIB_lud_inv_matTrans_init_ci(int32_t order, int32_t colStride, uint8_t *pBlock)
{
   ...
   se0Params.DIM1    = colStride;
   se0Params.ICNT2   = nVec;
   se0Params.DIM2    = colStride * eleCount * 2;
...
template void DSPLIB_lud_inv_matTrans_init_ci<float>(int32_t order, int32_t colStride, uint8_t *pBlock);
template void DSPLIB_lud_inv_matTrans_init_ci<double>(int32_t order, int32_t colStride, uint8_t *pBlock);
...
void DSPLIB_lud_inv_matTrans_ci(dataType *pIn, dataType *pOut, int32_t order, int32_t colStride, uint8_t *pBlock)
{
   ...
   __SE0_OPEN(pIn, se0Params);
   __SE1_OPEN(pIn + (colStride * eleCount), se0Params);
   __SA0_OPEN(sa0Params);
...
template void
DSPLIB_lud_inv_matTrans_ci<float>(float *pIn, float *pOut, int32_t order, int32_t colStride, uint8_t *pBlock);
template void
DSPLIB_lud_inv_matTrans_ci<double>(double *pIn, double *pOut, int32_t order, int32_t colStride, uint8_t *pBlock);

/* ======================================================================== */
/*  End of file:  DSPLIB_lud_common.cpp          */
/* ======================================================================== */
