...
extern DSPLIB_STATUS DSPLIB_cascadeBiquad_init_ci(DSPLIB_kernelHandle                  handle,
 ...
 */
template <typename dataType>
extern DSPLIB_STATUS DSPLIB_cascadeBiquad7Stage_init_ci(DSPLIB_kernelHandle                  handle,
                                                        const DSPLIB_bufParams2D_t          *bufParamsIn,
                                                        const DSPLIB_bufParams1D_t          *bufParamsFilterCoeff,
                                                        const DSPLIB_bufParams2D_t          *bufParamsFilterVar,
                                                        const DSPLIB_bufParams2D_t          *bufParamsOut,
 ...
 */
template <typename dataType>
extern DSPLIB_STATUS DSPLIB_cascadeBiquad_exec_ci(DSPLIB_kernelHandle handle,
                                                  void *restrict pIn,
                                                  void *restrict pFilterCoeff,
                                                  void *restrict pFilterVar,
                                                  void *restrict pOut);
...
template <typename dataType>
extern DSPLIB_STATUS DSPLIB_cascadeBiquad7Stage_exec_ci(DSPLIB_kernelHandle handle,
                                                        void *restrict pIn,
                                                        void *restrict pFilterCoeff,
                                                        void *restrict pFilterVar,
                                                        void *restrict pOut);
 ...
 */
template <typename dataType>
extern DSPLIB_STATUS DSPLIB_cascadeBiquad_exec_cn(DSPLIB_kernelHandle handle,
                                                  void *restrict pIn,
                                                  void *restrict pFilterCoeff,
                                                  void *restrict pFilterVar,
                                                  void *restrict pOut);
