...
/********************************************************************************
 *  @file     DSPLIB_sqr_priv.h
 *
 *  @brief    File to hold private parameter of function DSPLIB_sqr
 *
 *  @version  0.1 - Mar 2022 : Initial Version
 *
 ********************************************************************************/

#ifndef DSPLIB_SQR_IXX_IXX_OXX_PRIV_H_
#define DSPLIB_SQR_IXX_IXX_OXX_PRIV_H_

#include "../common/DSPLIB_utility.h"
#include "DSPLIB_sqr.h"
 ...
 *        @ref DSPLIB_sqr_PrivArgs structure.
 *
 */
#define DSPLIB_SQR_IXX_IXX_OXX_PBLOCK_SIZE (2 * SE_PARAM_SIZE + 1 * DSPLIB_PARAM_SIZE + 2 * sizeof(int32_t))

/**
 *  @brief This is a function pointer type that conforms to the
 *         declaration of @ref DSPLIB_sqr_exec_ci
 *         and @ref DSPLIB_sqr_exec_cn.
 */
typedef DSPLIB_STATUS (*pFxnDSPLIB_sqr_exec)(DSPLIB_kernelHandle handle, void *restrict pIn, void *restrict pOut);

/**
 *  @brief This function is the initialization function for the C7x
 *         implementation of the kernel. The function declaration conforms
 *         to the declaration of @ref DSPLIB_sqr_init.
 *
 * @details This function determines the configuration for the streaming engine
 *          and MMA hardware resources based on the function call parameters,
 *          and the configuration is saved in bufPBlock array. In the kernel
 *          call sequence, @ref DSPLIB_sqr_exec_ci would be
 *          called later independently by the application. When
 *          @ref DSPLIB_sqr_exec_ci runs, it merely retrieves
 *          the configuration from the bufPBlock and uses it to set up the
 *          hardware resources. This arrangement is so that
 *          @ref DSPLIB_sqr_exec_ci does not lose cycles
...
extern DSPLIB_STATUS DSPLIB_sqr_init_ci(DSPLIB_kernelHandle         handle,
 ...
 *         implementation of the kernel. The function declaration conforms
 *         to the declaration of @ref DSPLIB_sqr_exec.
 *
...
extern DSPLIB_STATUS DSPLIB_sqr_exec_ci(DSPLIB_kernelHandle handle, void *restrict pIn, void *restrict pOut);
 ...
 */
template <typename dataType, int32_t dataIn>
extern DSPLIB_STATUS DSPLIB_sqr_exec_cn(DSPLIB_kernelHandle handle, void *restrict pIn, void *restrict pOut);
...
typedef struct {
    ...
    *         @ref DSPLIB_sqr_exec_cn and
    *         @ref DSPLIB_sqr_exec_ci.                        */
   pFxnDSPLIB_sqr_exec execute;
   /** @brief Size of input buffer for different batches
    *         @ref DSPLIB_sqr_init that will be retrieved
    *         and used by @ref DSPLIB_sqr_exec                */
   int32_t blockSize;
 ...
 */
DSPLIB_STATUS
DSPLIB_sqr_init_cn(DSPLIB_kernelHandle handle, DSPLIB_bufParams2D_t *bufParamsIn, DSPLIB_bufParams2D_t *bufParamsOut);

#endif /* DSPLIB_SQR_IXX_IXX_OXX_PRIV_H_ */

/* ======================================================================== */
/*  End of file:  DSPLIB_sqr.h                                              */
/* ======================================================================== */
