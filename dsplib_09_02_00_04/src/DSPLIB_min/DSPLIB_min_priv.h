...
/********************************************************************************
 *  @file     DSPLIB_min_priv.h
 *
 *  @brief    File to hold private parameter of function DSPLIB_min
 *
 *  @version  0.1 - Mar 2022 : Initial Version
 *
 ********************************************************************************/

#ifndef DSPLIB_MIN_IXX_IXX_OXX_PRIV_H_
#define DSPLIB_MIN_IXX_IXX_OXX_PRIV_H_

#include "../common/DSPLIB_utility.h"
#include "DSPLIB_min.h"
 ...
 *        @ref DSPLIB_min_PrivArgs structure.
 *
 */
 ...
 *         declaration of @ref DSPLIB_min_exec_ci
 *         and @ref DSPLIB_min_exec_cn.
 */
 ...
 *         to the declaration of @ref DSPLIB_min_init.
 *
 * @details This function determines the configuration for the streaming engine
 *          and MMA hardware resources based on the function call parameters,
 *          and the configuration is saved in bufPBlock array. In the kernel
 *          call sequence, @ref DSPLIB_min_exec_ci would be
 *          called later independently by the application. When
 *          @ref DSPLIB_min_exec_ci runs, it merely retrieves
 *          the configuration from the bufPBlock and uses it to set up the
 *          hardware resources. This arrangement is so that
 *          @ref DSPLIB_min_exec_ci does not lose cycles
...
extern DSPLIB_STATUS DSPLIB_min_init_ci(DSPLIB_kernelHandle         handle,
 ...
 *         implementation of the kernel. The function declaration conforms
 *         to the declaration of @ref DSPLIB_min_exec.
 *
...
extern DSPLIB_STATUS DSPLIB_min_exec_ci(DSPLIB_kernelHandle handle, void *restrict pIn, void *restrict pOut);
 ...
 */
template <typename dataType, int32_t dataIn>
extern DSPLIB_STATUS DSPLIB_min_exec_cn(DSPLIB_kernelHandle handle, void *restrict pIn, void *restrict pOut);
...
typedef struct {
    ...
    *         @ref DSPLIB_min_exec_cn and
    *         @ref DSPLIB_min_exec_ci.                        */
   pFxnDSPLIB_min_exec execute;
   /** @brief Size of input buffer for different batches
    *         @ref DSPLIB_min_init that will be retrieved
    *         and used by @ref DSPLIB_min_exec                */
   int32_t blockSize;
   uint8_t bufPblock[DSPLIB_MIN_IXX_IXX_OXX_PBLOCK_SIZE];
} DSPLIB_min_PrivArgs;
 ...
 *         DSPLIB_min_exec_ci and this method performs the loops needed to
 *         calculate the vector containing all of the minimum values.
 *
 * @details
 *
 ...
 *
 *  @return      Vector containing all minimum values.
 *
 */
template <typename T, typename vec> vec DSPLIB_min_loopLogic(size_t length, size_t width, T *pSrc);

#endif /* DSPLIB_MIN_IXX_IXX_OXX_PRIV_H_ */

/* ======================================================================== */
/*  End of file:  DSPLIB_min.h                                              */
/* ======================================================================== */