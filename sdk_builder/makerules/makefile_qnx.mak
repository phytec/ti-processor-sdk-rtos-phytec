...
ifeq ($(QNX_SDP_VERSION),710)
	cp $(PSDK_QNX_PATH)/qnx/bsp/images/ifs-$(SOC)-evm-ti-spl-nfs-with-asix.raw $(QNX_AUX_FS_PATH)/qnx-ifs-spl-nfs-asix
ifneq ($(SOC),j722s)
	cp $(PSDK_QNX_PATH)/qnx/bsp/images/ifs-$(SOC)-evm-ti-spl-nfs-with-cpsw2g.raw $(QNX_AUX_FS_PATH)/qnx-ifs-spl-nfs-cpsw2g
endif
endif
ifeq ($(BUILD_CPU_MCU1_0),yes)
ifeq ($(BUILD_TARGET_MODE),yes)
