...
# Adding this flag to keep parity with Linux, given that this is tied to
# a waiver used within TIOVX for MISRA-C
#
# More details can be found below, which are in place in the Linux file
#
