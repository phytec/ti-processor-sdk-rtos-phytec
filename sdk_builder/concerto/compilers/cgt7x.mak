...
$(_MODULE)_COPT := --abi=eabi --gcc --gen_func_subsections
ifeq ($(TARGET_OS),SYSBIOS)
	$(_MODULE)_XDC_TARGET := ti.targets.elf.C71
endif
...
# Turn of C7x compiler advice, this is enabled from 4.1.0 version onwards
$(_MODULE)_COPT += --advice:performance=none
...
ifeq ($(TARGET_OS),SYSBIOS)
	$(_MODULE)_DEFS += xdc_target_name__=C71 xdc_target_types__=ti/targets/elf/std.h
endif
...
$(_MODULE)_LDFLAGS  := $($(_MODULE)_CFLAGS) --issue_remarks -z --warn_sections --reread_libs --rom_model $($(_MODULE)_LINKER_CMD_FILES)
