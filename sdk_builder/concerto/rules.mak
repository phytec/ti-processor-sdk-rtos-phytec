...
MODULES:=
CONCERTO_TARGETS :=
CONCERTO_TARGETS_LIBS :=
CONCERTO_TARGETS_DSMOS :=
CONCERTO_TARGETS_EXES :=
...
ifndef NO_TARGETS
.PHONY: all dir depend build install uninstall clean clean_target outputs modules targets scrub vars test docs clean_docs pdf release prebuilt_libs targets_libs targets_dsmos targets_exes build_libs build_dsmos build_exes
...
targets_libs::
	$(foreach target,$(CONCERTO_TARGETS_LIBS),$(info CONCERTO_TARGETS_LIBS+=$(target)))

targets_dsmos::
	$(foreach target,$(CONCERTO_TARGETS_DSMOS),$(info CONCERTO_TARGETS_DSMOS+=$(target)))

targets_exes::
	$(foreach target,$(CONCERTO_TARGETS_EXES),$(info CONCERTO_TARGETS_EXES+=$(target)))

build_libs::
	$(MAKE) $(CONCERTO_TARGETS_LIBS)

build_dsmos::
	$(MAKE) $(CONCERTO_TARGETS_DSMOS)

build_exes::
	$(MAKE) $(CONCERTO_TARGETS_EXES)
