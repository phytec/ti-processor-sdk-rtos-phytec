...
PROTOBUF_CONSTEXPR VariableDef::VariableDef(
  ...
  , initializer_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , snapshot_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
...
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_tensorflow_2fcore_2fframework_2fvariable_2eproto = nullptr;
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 10, -1, -1, sizeof(::tensorflow::SaveSliceInfoDef)},
};
...
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fvariable_2eproto = {
    false, false, 356, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fvariable_2eproto,
...
VariableDef::VariableDef(const VariableDef& from)
  ...
  initializer_name_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    initializer_name_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_initializer_name().empty()) {
    initializer_name_.Set(from._internal_initializer_name(), 
      GetArenaForAllocation());
  }
  snapshot_name_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    snapshot_name_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_snapshot_name().empty()) {
    snapshot_name_.Set(from._internal_snapshot_name(), 
      GetArenaForAllocation());
  }
...
inline void VariableDef::SharedDtor() {
  ...
  initializer_name_.Destroy();
  snapshot_name_.Destroy();
...
// @@protoc_insertion_point(message_clear_start:tensorflow.VariableDef)
  ...
  initializer_name_.ClearToEmpty();
  snapshot_name_.ClearToEmpty();
  if (GetArenaForAllocation() == nullptr && save_slice_info_def_ != nullptr) {
...
void VariableDef::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<VariableDef *>(to)->MergeFrom(
      static_cast<const VariableDef &>(from));
}
...
void VariableDef::InternalSwap(VariableDef* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &initializer_name_, lhs_arena,
      &other->initializer_name_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &snapshot_name_, lhs_arena,
      &other->snapshot_name_, rhs_arena
  );
...
void SaveSliceInfoDef::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<SaveSliceInfoDef *>(to)->MergeFrom(
      static_cast<const SaveSliceInfoDef &>(from));
}
