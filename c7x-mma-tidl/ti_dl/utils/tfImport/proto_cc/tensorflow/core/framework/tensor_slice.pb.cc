...
PROTOBUF_CONSTEXPR TensorSliceProto_Extent::TensorSliceProto_Extent(
    ::_pbi::ConstantInitialized)
  : start_(int64_t{0})
  , _oneof_case_{}{}
struct TensorSliceProto_ExtentDefaultTypeInternal {
  PROTOBUF_CONSTEXPR TensorSliceProto_ExtentDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TensorSliceProto_ExtentDefaultTypeInternal _TensorSliceProto_Extent_default_instance_;
PROTOBUF_CONSTEXPR TensorSliceProto::TensorSliceProto(
    ::_pbi::ConstantInitialized)
  : extent_(){}
struct TensorSliceProtoDefaultTypeInternal {
  PROTOBUF_CONSTEXPR TensorSliceProtoDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TensorSliceProtoDefaultTypeInternal _TensorSliceProto_default_instance_;
}  // namespace tensorflow
static ::_pb::Metadata file_level_metadata_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto = nullptr;

const uint32_t TableStruct_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 9, -1, -1, sizeof(::tensorflow::TensorSliceProto)},
};
...
const char descriptor_table_protodef_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto = {
    false, false, 249, descriptor_table_protodef_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto,
    ...
    file_level_metadata_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto, file_level_enum_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto,
    file_level_service_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto_getter() {
  return &descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto(&descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fslice_2eproto);
namespace tensorflow {
...
inline void TensorSliceProto_Extent::SharedCtor() {
start_ = int64_t{0};
clear_has_has_length();
}
...
inline void TensorSliceProto_Extent::SharedDtor() {
...
const char* TensorSliceProto_Extent::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData TensorSliceProto_Extent::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    TensorSliceProto_Extent::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*TensorSliceProto_Extent::GetClassData() const { return &_class_data_; }

void TensorSliceProto_Extent::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TensorSliceProto_Extent *>(to)->MergeFrom(
      static_cast<const TensorSliceProto_Extent &>(from));
}
...
inline void TensorSliceProto::SharedCtor() {
}
...
inline void TensorSliceProto::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}
...
const char* TensorSliceProto::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    uint32_t tag;
    ptr = ::_pbi::ReadTag(ptr, &tag);
...
uint8_t* TensorSliceProto::_InternalSerialize(
  ...
  // repeated .tensorflow.TensorSliceProto.Extent extent = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_extent_size()); i < n; i++) {
    const auto& repfield = this->_internal_extent(i);
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData TensorSliceProto::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSizeCheck,
    TensorSliceProto::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*TensorSliceProto::GetClassData() const { return &_class_data_; }

void TensorSliceProto::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<TensorSliceProto *>(to)->MergeFrom(
      static_cast<const TensorSliceProto &>(from));
}
...
template<> PROTOBUF_NOINLINE ::tensorflow::TensorSliceProto_Extent*
...
template<> PROTOBUF_NOINLINE ::tensorflow::TensorSliceProto*
