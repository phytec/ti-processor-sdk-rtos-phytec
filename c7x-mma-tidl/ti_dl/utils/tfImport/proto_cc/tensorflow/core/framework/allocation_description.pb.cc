...
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto = {
    false, false, 304, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fallocation_5fdescription_2eproto,
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&requested_bytes_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&has_single_reference_) -
    reinterpret_cast<char*>(&requested_bytes_)) + sizeof(has_single_reference_));
}
...
void AllocationDescription::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message* to,
                      const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  static_cast<AllocationDescription *>(to)->MergeFrom(
      static_cast<const AllocationDescription &>(from));
}
