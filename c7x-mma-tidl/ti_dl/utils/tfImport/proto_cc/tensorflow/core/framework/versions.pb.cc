...
struct VersionDefDefaultTypeInternal {
  PROTOBUF_CONSTEXPR VersionDefDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 VersionDefDefaultTypeInternal _VersionDef_default_instance_;
}  // namespace tensorflow
static ::_pb::Metadata file_level_metadata_tensorflow_2fcore_2fframework_2fversions_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_tensorflow_2fcore_2fframework_2fversions_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_tensorflow_2fcore_2fframework_2fversions_2eproto = nullptr;

const uint32_t TableStruct_tensorflow_2fcore_2fframework_2fversions_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::tensorflow::VersionDef)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::tensorflow::_VersionDef_default_instance_._instance,
};
...
const char descriptor_table_protodef_tensorflow_2fcore_2fframework_2fversions_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto = {
    false, false, 188, descriptor_table_protodef_tensorflow_2fcore_2fframework_2fversions_2eproto,
    "tensorflow/core/framework/versions.proto",
    &descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_tensorflow_2fcore_2fframework_2fversions_2eproto::offsets,
    file_level_metadata_tensorflow_2fcore_2fframework_2fversions_2eproto, file_level_enum_descriptors_tensorflow_2fcore_2fframework_2fversions_2eproto,
    file_level_service_descriptors_tensorflow_2fcore_2fframework_2fversions_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_getter() {
  return &descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_tensorflow_2fcore_2fframework_2fversions_2eproto(&descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto);
namespace tensorflow {
...
uint8_t* VersionDef::_InternalSerialize(
  ...
  if (this->_internal_producer() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(1, this->_internal_producer(), target);
  }

  // int32 min_consumer = 2;
  if (this->_internal_min_consumer() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(2, this->_internal_min_consumer(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:tensorflow.VersionDef)
  ...
  // int32 producer = 1;
  if (this->_internal_producer() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_producer());
  }

  // int32 min_consumer = 2;
  if (this->_internal_min_consumer() != 0) {
    total_size += ::_pbi::WireFormatLite::Int32SizePlusOne(this->_internal_min_consumer());
  }
...
::PROTOBUF_NAMESPACE_ID::Metadata VersionDef::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_getter, &descriptor_table_tensorflow_2fcore_2fframework_2fversions_2eproto_once,
      file_level_metadata_tensorflow_2fcore_2fframework_2fversions_2eproto[0]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace tensorflow
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::tensorflow::VersionDef*
Arena::CreateMaybeMessage< ::tensorflow::VersionDef >(Arena* arena) {
