...
class TensorProto final :
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::ResourceHandle >*
      mutable_resource_handle_val();
  private:
  const ::tensorflow::ResourceHandle& _internal_resource_handle_val(int index) const;
  ::tensorflow::ResourceHandle* _internal_add_resource_handle_val();
  public:
  const ::tensorflow::ResourceHandle& resource_handle_val(int index) const;
  ::tensorflow::ResourceHandle* add_resource_handle_val();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::ResourceHandle >&
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::ResourceHandle > resource_handle_val_;
...
void TensorProto::set_tensor_content(ArgT0&& arg0, ArgT... args) {
 ...
 tensor_content_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void TensorProto::_internal_set_tensor_content(const std::string& value) {
  ...
  tensor_content_.Set(value, GetArenaForAllocation());
}
inline std::string* TensorProto::_internal_mutable_tensor_content() {
  
  return tensor_content_.Mutable(GetArenaForAllocation());
}
inline std::string* TensorProto::release_tensor_content() {
  ...
  return tensor_content_.Release();
}
inline void TensorProto::set_allocated_tensor_content(std::string* tensor_content) {
  ...
  tensor_content_.SetAllocated(tensor_content, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (tensor_content_.IsDefault()) {
    tensor_content_.Set("", GetArenaForAllocation());
  }
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::ResourceHandle >*
...
inline const ::tensorflow::ResourceHandle& TensorProto::_internal_resource_handle_val(int index) const {
...
inline ::tensorflow::ResourceHandle* TensorProto::_internal_add_resource_handle_val() {
  return resource_handle_val_.Add();
}
inline ::tensorflow::ResourceHandle* TensorProto::add_resource_handle_val() {
  ::tensorflow::ResourceHandle* _add = _internal_add_resource_handle_val();
  // @@protoc_insertion_point(field_add:tensorflow.TensorProto.resource_handle_val)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::tensorflow::ResourceHandle >&
