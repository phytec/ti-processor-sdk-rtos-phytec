...
class FunctionDef_Node final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR FunctionDef_Node(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void FunctionDef_Node::set_op(ArgT0&& arg0, ArgT... args) {
 ...
 op_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void FunctionDef_Node::_internal_set_op(const std::string& value) {
  ...
  op_.Set(value, GetArenaForAllocation());
}
inline std::string* FunctionDef_Node::_internal_mutable_op() {
  
  return op_.Mutable(GetArenaForAllocation());
}
...
inline void FunctionDef_Node::set_allocated_op(std::string* op) {
  ...
  op_.SetAllocated(op, GetArenaForAllocation());
...
inline ::tensorflow::FunctionDef_Node* FunctionDef::add_node() {
  ::tensorflow::FunctionDef_Node* _add = _internal_add_node();
...
void GradientDef::set_function_name(ArgT0&& arg0, ArgT... args) {
 ...
 function_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void GradientDef::_internal_set_function_name(const std::string& value) {
  ...
  function_name_.Set(value, GetArenaForAllocation());
}
inline std::string* GradientDef::_internal_mutable_function_name() {
  
  return function_name_.Mutable(GetArenaForAllocation());
}
...
inline void GradientDef::set_allocated_function_name(std::string* function_name) {
  ...
  function_name_.SetAllocated(function_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (function_name_.IsDefault()) {
...
void GradientDef::set_gradient_func(ArgT0&& arg0, ArgT... args) {
 ...
 gradient_func_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void GradientDef::_internal_set_gradient_func(const std::string& value) {
  ...
  gradient_func_.Set(value, GetArenaForAllocation());
}
inline std::string* GradientDef::_internal_mutable_gradient_func() {
  
  return gradient_func_.Mutable(GetArenaForAllocation());
}
...
inline void GradientDef::set_allocated_gradient_func(std::string* gradient_func) {
  ...
  gradient_func_.SetAllocated(gradient_func, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (gradient_func_.IsDefault()) {
