...
struct TensorShapeProto_DimDefaultTypeInternal {
  PROTOBUF_CONSTEXPR TensorShapeProto_DimDefaultTypeInternal()
...
static ::_pb::Metadata file_level_metadata_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto = nullptr;

const uint32_t TableStruct_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::tensorflow::TensorShapeProto_Dim)},
  { 8, -1, -1, sizeof(::tensorflow::TensorShapeProto)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::tensorflow::_TensorShapeProto_Dim_default_instance_._instance,
  &::tensorflow::_TensorShapeProto_default_instance_._instance,
};
...
const char descriptor_table_protodef_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "o3"
  ;
static ::_pbi::once_flag descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto = {
    false, false, 242, descriptor_table_protodef_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto,
    ...
    file_level_metadata_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto, file_level_enum_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto,
    file_level_service_descriptors_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto_getter() {
  return &descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto(&descriptor_table_tensorflow_2fcore_2fframework_2ftensor_5fshape_2eproto);
namespace tensorflow {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "tensorflow.TensorShapeProto.Dim.name"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* TensorShapeProto::_InternalSerialize(
  ...
  if (this->_internal_unknown_rank() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(3, this->_internal_unknown_rank(), target);
  }
...
template<> PROTOBUF_NOINLINE ::tensorflow::TensorShapeProto_Dim*
Arena::CreateMaybeMessage< ::tensorflow::TensorShapeProto_Dim >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::TensorShapeProto_Dim >(arena);
}
template<> PROTOBUF_NOINLINE ::tensorflow::TensorShapeProto*
Arena::CreateMaybeMessage< ::tensorflow::TensorShapeProto >(Arena* arena) {
