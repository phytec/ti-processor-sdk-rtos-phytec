...
class Matcher final :
 ...
 public:
  ...
  ~Matcher() override;
  explicit PROTOBUF_CONSTEXPR Matcher(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  Matcher* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::ArgMaxMatcher* release_argmax_matcher();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::BipartiteMatcher* release_bipartite_matcher();
