...
class TrainEvalPipelineConfig final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TrainEvalPipelineConfig(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TrainEvalPipelineConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::DetectionModel* release_model();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::TrainConfig* release_train_config();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::InputReader* release_train_input_reader();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::EvalConfig* release_eval_config();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::GraphRewriter* release_graph_rewriter();
