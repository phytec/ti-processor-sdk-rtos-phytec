...
class StringIntLabelMapItem final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StringIntLabelMapItem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  StringIntLabelMapItem* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class StringIntLabelMap final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR StringIntLabelMap(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  StringIntLabelMap* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline int32_t StringIntLabelMapItem::_internal_id() const {
  return id_;
}
inline int32_t StringIntLabelMapItem::id() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.StringIntLabelMapItem.id)
  return _internal_id();
}
inline void StringIntLabelMapItem::_internal_set_id(int32_t value) {
  _has_bits_[0] |= 0x00000004u;
  id_ = value;
}
inline void StringIntLabelMapItem::set_id(int32_t value) {
