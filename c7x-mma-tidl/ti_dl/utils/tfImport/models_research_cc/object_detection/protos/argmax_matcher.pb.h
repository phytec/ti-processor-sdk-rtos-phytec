...
class ArgMaxMatcher final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ArgMaxMatcher(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ArgMaxMatcher* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
