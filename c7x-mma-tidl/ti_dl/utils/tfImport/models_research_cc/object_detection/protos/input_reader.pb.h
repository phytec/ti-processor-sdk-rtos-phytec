...
class InputReader final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR InputReader(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  InputReader* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void set_num_epochs(uint32_t value);
  private:
  uint32_t _internal_num_epochs() const;
  void _internal_set_num_epochs(uint32_t value);
  public:
  ...
  uint32_t num_keypoints() const;
  void set_num_keypoints(uint32_t value);
  private:
  uint32_t _internal_num_keypoints() const;
  void _internal_set_num_keypoints(uint32_t value);
  public:
  ...
  int32_t num_additional_channels() const;
  void set_num_additional_channels(int32_t value);
  private:
  int32_t _internal_num_additional_channels() const;
  void _internal_set_num_additional_channels(int32_t value);
  public:
  ...
  PROTOBUF_DEPRECATED uint32_t queue_capacity() const;
  PROTOBUF_DEPRECATED void set_queue_capacity(uint32_t value);
  private:
  uint32_t _internal_queue_capacity() const;
  void _internal_set_queue_capacity(uint32_t value);
  public:
  ...
  PROTOBUF_DEPRECATED uint32_t min_after_dequeue() const;
  PROTOBUF_DEPRECATED void set_min_after_dequeue(uint32_t value);
  private:
  uint32_t _internal_min_after_dequeue() const;
  void _internal_set_min_after_dequeue(uint32_t value);
  public:
  ...
  void set_num_readers(uint32_t value);
  private:
  uint32_t _internal_num_readers() const;
  void _internal_set_num_readers(uint32_t value);
  public:
  ...
  uint32_t shuffle_buffer_size() const;
  void set_shuffle_buffer_size(uint32_t value);
  private:
  uint32_t _internal_shuffle_buffer_size() const;
  void _internal_set_shuffle_buffer_size(uint32_t value);
  public:
  ...
  uint32_t filenames_shuffle_buffer_size() const;
  void set_filenames_shuffle_buffer_size(uint32_t value);
  private:
  uint32_t _internal_filenames_shuffle_buffer_size() const;
  void _internal_set_filenames_shuffle_buffer_size(uint32_t value);
  public:
  ...
  PROTOBUF_DEPRECATED uint32_t prefetch_size() const;
  PROTOBUF_DEPRECATED void set_prefetch_size(uint32_t value);
  private:
  uint32_t _internal_prefetch_size() const;
  void _internal_set_prefetch_size(uint32_t value);
  public:
  ...
  PROTOBUF_DEPRECATED uint32_t num_parallel_map_calls() const;
  PROTOBUF_DEPRECATED void set_num_parallel_map_calls(uint32_t value);
  private:
  uint32_t _internal_num_parallel_map_calls() const;
  void _internal_set_num_parallel_map_calls(uint32_t value);
  public:
  ...
  uint32_t read_block_length() const;
  void set_read_block_length(uint32_t value);
  private:
  uint32_t _internal_read_block_length() const;
  void _internal_set_read_block_length(uint32_t value);
  public:
  ...
  uint32_t num_parallel_batches() const;
  void set_num_parallel_batches(uint32_t value);
  private:
  uint32_t _internal_num_parallel_batches() const;
  void _internal_set_num_parallel_batches(uint32_t value);
  public:
  ...
  int32_t num_prefetch_batches() const;
  void set_num_prefetch_batches(int32_t value);
  private:
  int32_t _internal_num_prefetch_batches() const;
  void _internal_set_num_prefetch_batches(int32_t value);
  public:
  ...
  int32_t max_number_of_boxes() const;
  void set_max_number_of_boxes(int32_t value);
  private:
  int32_t _internal_max_number_of_boxes() const;
  void _internal_set_max_number_of_boxes(int32_t value);
  public:
  ...
  uint32_t sample_1_of_n_examples() const;
  void set_sample_1_of_n_examples(uint32_t value);
  private:
  uint32_t _internal_sample_1_of_n_examples() const;
  void _internal_set_sample_1_of_n_examples(uint32_t value);
  public:
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::TFRecordInputReader* release_tf_record_input_reader();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::ExternalInputReader* release_external_input_reader();
 ...
 private:
  ...
  uint32_t num_keypoints_;
  int32_t num_additional_channels_;
  bool shuffle_;
  uint32_t queue_capacity_;
  uint32_t min_after_dequeue_;
  uint32_t num_readers_;
  int mask_type_;
  uint32_t shuffle_buffer_size_;
  uint32_t filenames_shuffle_buffer_size_;
  uint32_t prefetch_size_;
  uint32_t num_parallel_map_calls_;
  uint32_t read_block_length_;
  uint32_t num_parallel_batches_;
  int32_t num_prefetch_batches_;
  int32_t max_number_of_boxes_;
  uint32_t sample_1_of_n_examples_;
...
class TFRecordInputReader final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR TFRecordInputReader(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  TFRecordInputReader* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class ExternalInputReader final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR ExternalInputReader(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  ExternalInputReader* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
void InputReader::set_label_map_path(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 label_map_path_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void InputReader::_internal_set_label_map_path(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  label_map_path_.Set(value, GetArenaForAllocation());
}
inline std::string* InputReader::_internal_mutable_label_map_path() {
  _has_bits_[0] |= 0x00000001u;
  return label_map_path_.Mutable(GetArenaForAllocation());
}
inline std::string* InputReader::release_label_map_path() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = label_map_path_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (label_map_path_.IsDefault()) {
...
inline void InputReader::set_allocated_label_map_path(std::string* label_map_path) {
  ...
  label_map_path_.SetAllocated(label_map_path, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (label_map_path_.IsDefault()) {
    label_map_path_.Set("", GetArenaForAllocation());
  }
...
inline uint32_t InputReader::_internal_shuffle_buffer_size() const {
  return shuffle_buffer_size_;
}
inline uint32_t InputReader::shuffle_buffer_size() const {
...
inline void InputReader::_internal_set_shuffle_buffer_size(uint32_t value) {
  _has_bits_[0] |= 0x00001000u;
  shuffle_buffer_size_ = value;
}
inline void InputReader::set_shuffle_buffer_size(uint32_t value) {
...
inline uint32_t InputReader::_internal_filenames_shuffle_buffer_size() const {
  return filenames_shuffle_buffer_size_;
}
inline uint32_t InputReader::filenames_shuffle_buffer_size() const {
...
inline void InputReader::_internal_set_filenames_shuffle_buffer_size(uint32_t value) {
  _has_bits_[0] |= 0x00002000u;
  filenames_shuffle_buffer_size_ = value;
}
inline void InputReader::set_filenames_shuffle_buffer_size(uint32_t value) {
...
inline uint32_t InputReader::_internal_num_epochs() const {
  return num_epochs_;
}
inline uint32_t InputReader::num_epochs() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.InputReader.num_epochs)
  return _internal_num_epochs();
}
inline void InputReader::_internal_set_num_epochs(uint32_t value) {
  _has_bits_[0] |= 0x00000004u;
  num_epochs_ = value;
}
inline void InputReader::set_num_epochs(uint32_t value) {
...
inline uint32_t InputReader::_internal_sample_1_of_n_examples() const {
  return sample_1_of_n_examples_;
}
inline uint32_t InputReader::sample_1_of_n_examples() const {
...
inline void InputReader::_internal_set_sample_1_of_n_examples(uint32_t value) {
  _has_bits_[0] |= 0x00100000u;
  sample_1_of_n_examples_ = value;
}
inline void InputReader::set_sample_1_of_n_examples(uint32_t value) {
...
inline uint32_t InputReader::_internal_num_readers() const {
  return num_readers_;
}
inline uint32_t InputReader::num_readers() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.InputReader.num_readers)
  return _internal_num_readers();
}
inline void InputReader::_internal_set_num_readers(uint32_t value) {
  _has_bits_[0] |= 0x00000400u;
  num_readers_ = value;
}
inline void InputReader::set_num_readers(uint32_t value) {
...
inline uint32_t InputReader::_internal_num_parallel_batches() const {
  return num_parallel_batches_;
}
inline uint32_t InputReader::num_parallel_batches() const {
...
inline void InputReader::_internal_set_num_parallel_batches(uint32_t value) {
  _has_bits_[0] |= 0x00020000u;
  num_parallel_batches_ = value;
}
inline void InputReader::set_num_parallel_batches(uint32_t value) {
...
inline int32_t InputReader::_internal_num_prefetch_batches() const {
  return num_prefetch_batches_;
}
inline int32_t InputReader::num_prefetch_batches() const {
...
inline void InputReader::_internal_set_num_prefetch_batches(int32_t value) {
  _has_bits_[0] |= 0x00040000u;
  num_prefetch_batches_ = value;
}
inline void InputReader::set_num_prefetch_batches(int32_t value) {
...
inline uint32_t InputReader::_internal_queue_capacity() const {
  return queue_capacity_;
}
inline uint32_t InputReader::queue_capacity() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.InputReader.queue_capacity)
  return _internal_queue_capacity();
}
inline void InputReader::_internal_set_queue_capacity(uint32_t value) {
  _has_bits_[0] |= 0x00000100u;
  queue_capacity_ = value;
}
inline void InputReader::set_queue_capacity(uint32_t value) {
...
inline uint32_t InputReader::_internal_min_after_dequeue() const {
  return min_after_dequeue_;
}
inline uint32_t InputReader::min_after_dequeue() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.InputReader.min_after_dequeue)
  return _internal_min_after_dequeue();
}
inline void InputReader::_internal_set_min_after_dequeue(uint32_t value) {
  _has_bits_[0] |= 0x00000200u;
  min_after_dequeue_ = value;
}
inline void InputReader::set_min_after_dequeue(uint32_t value) {
...
inline uint32_t InputReader::_internal_read_block_length() const {
  return read_block_length_;
}
inline uint32_t InputReader::read_block_length() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.InputReader.read_block_length)
  return _internal_read_block_length();
}
inline void InputReader::_internal_set_read_block_length(uint32_t value) {
  _has_bits_[0] |= 0x00010000u;
  read_block_length_ = value;
}
inline void InputReader::set_read_block_length(uint32_t value) {
...
inline uint32_t InputReader::_internal_prefetch_size() const {
  return prefetch_size_;
}
inline uint32_t InputReader::prefetch_size() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.InputReader.prefetch_size)
  return _internal_prefetch_size();
}
inline void InputReader::_internal_set_prefetch_size(uint32_t value) {
  _has_bits_[0] |= 0x00004000u;
  prefetch_size_ = value;
}
inline void InputReader::set_prefetch_size(uint32_t value) {
...
inline uint32_t InputReader::_internal_num_parallel_map_calls() const {
  return num_parallel_map_calls_;
}
inline uint32_t InputReader::num_parallel_map_calls() const {
...
inline void InputReader::_internal_set_num_parallel_map_calls(uint32_t value) {
  _has_bits_[0] |= 0x00008000u;
  num_parallel_map_calls_ = value;
}
inline void InputReader::set_num_parallel_map_calls(uint32_t value) {
...
inline int32_t InputReader::_internal_num_additional_channels() const {
  return num_additional_channels_;
}
inline int32_t InputReader::num_additional_channels() const {
...
inline void InputReader::_internal_set_num_additional_channels(int32_t value) {
  _has_bits_[0] |= 0x00000040u;
  num_additional_channels_ = value;
}
inline void InputReader::set_num_additional_channels(int32_t value) {
...
inline uint32_t InputReader::_internal_num_keypoints() const {
  return num_keypoints_;
}
inline uint32_t InputReader::num_keypoints() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.InputReader.num_keypoints)
  return _internal_num_keypoints();
}
inline void InputReader::_internal_set_num_keypoints(uint32_t value) {
  _has_bits_[0] |= 0x00000020u;
  num_keypoints_ = value;
}
inline void InputReader::set_num_keypoints(uint32_t value) {
...
inline int32_t InputReader::_internal_max_number_of_boxes() const {
  return max_number_of_boxes_;
}
inline int32_t InputReader::max_number_of_boxes() const {
...
inline void InputReader::_internal_set_max_number_of_boxes(int32_t value) {
  _has_bits_[0] |= 0x00080000u;
  max_number_of_boxes_ = value;
}
inline void InputReader::set_max_number_of_boxes(int32_t value) {
