...
class KeypointBoxCoder final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR KeypointBoxCoder(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  KeypointBoxCoder* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline int32_t KeypointBoxCoder::_internal_num_keypoints() const {
  return num_keypoints_;
}
inline int32_t KeypointBoxCoder::num_keypoints() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.KeypointBoxCoder.num_keypoints)
  return _internal_num_keypoints();
}
inline void KeypointBoxCoder::_internal_set_num_keypoints(int32_t value) {
  _has_bits_[0] |= 0x00000001u;
  num_keypoints_ = value;
}
inline void KeypointBoxCoder::set_num_keypoints(int32_t value) {
