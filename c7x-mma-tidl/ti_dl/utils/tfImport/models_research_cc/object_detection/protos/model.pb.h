...
class DetectionModel final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR DetectionModel(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  DetectionModel* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::FasterRcnn* release_faster_rcnn();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::Ssd* release_ssd();
