...
class BoxCoder final :
 ...
 public:
  ...
  ~BoxCoder() override;
  explicit PROTOBUF_CONSTEXPR BoxCoder(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  BoxCoder* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::FasterRcnnBoxCoder* release_faster_rcnn_box_coder();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::MeanStddevBoxCoder* release_mean_stddev_box_coder();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::SquareBoxCoder* release_square_box_coder();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::KeypointBoxCoder* release_keypoint_box_coder();
