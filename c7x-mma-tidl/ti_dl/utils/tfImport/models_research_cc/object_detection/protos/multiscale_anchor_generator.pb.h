...
class MultiscaleAnchorGenerator final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR MultiscaleAnchorGenerator(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  MultiscaleAnchorGenerator* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
inline int32_t MultiscaleAnchorGenerator::_internal_min_level() const {
  return min_level_;
}
inline int32_t MultiscaleAnchorGenerator::min_level() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.MultiscaleAnchorGenerator.min_level)
  return _internal_min_level();
}
inline void MultiscaleAnchorGenerator::_internal_set_min_level(int32_t value) {
  _has_bits_[0] |= 0x00000002u;
  min_level_ = value;
}
inline void MultiscaleAnchorGenerator::set_min_level(int32_t value) {
...
inline int32_t MultiscaleAnchorGenerator::_internal_max_level() const {
  return max_level_;
}
inline int32_t MultiscaleAnchorGenerator::max_level() const {
  // @@protoc_insertion_point(field_get:object_detection.protos.MultiscaleAnchorGenerator.max_level)
  return _internal_max_level();
}
inline void MultiscaleAnchorGenerator::_internal_set_max_level(int32_t value) {
  _has_bits_[0] |= 0x00000004u;
  max_level_ = value;
}
inline void MultiscaleAnchorGenerator::set_max_level(int32_t value) {
...
inline int32_t MultiscaleAnchorGenerator::_internal_scales_per_octave() const {
  return scales_per_octave_;
}
inline int32_t MultiscaleAnchorGenerator::scales_per_octave() const {
...
inline void MultiscaleAnchorGenerator::_internal_set_scales_per_octave(int32_t value) {
  _has_bits_[0] |= 0x00000010u;
  scales_per_octave_ = value;
}
inline void MultiscaleAnchorGenerator::set_scales_per_octave(int32_t value) {
