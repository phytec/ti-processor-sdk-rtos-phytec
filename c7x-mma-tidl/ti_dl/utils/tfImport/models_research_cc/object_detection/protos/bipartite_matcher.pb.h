...
class BipartiteMatcher final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:object_detection.protos.BipartiteMatcher) */ {
 public:
  inline BipartiteMatcher() : BipartiteMatcher(nullptr) {}
  ~BipartiteMatcher() override;
  explicit PROTOBUF_CONSTEXPR BipartiteMatcher(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(BipartiteMatcher* other) {
    if (other == this) return;
  ...
  BipartiteMatcher* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  protected:
  explicit BipartiteMatcher(::PROTOBUF_NAMESPACE_ID::Arena* arena,
...
// optional bool use_matmul_gather = 6 [default = false];
inline bool BipartiteMatcher::_internal_has_use_matmul_gather() const {
...
inline bool BipartiteMatcher::_internal_use_matmul_gather() const {
...
inline void BipartiteMatcher::_internal_set_use_matmul_gather(bool value) {
  _has_bits_[0] |= 0x00000001u;
