...
class AnchorGenerator final :
 ...
 public:
  ...
  explicit PROTOBUF_CONSTEXPR AnchorGenerator(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  AnchorGenerator* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::GridAnchorGenerator* release_grid_anchor_generator();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::SsdAnchorGenerator* release_ssd_anchor_generator();
  ...
  PROTOBUF_NODISCARD ::object_detection::protos::MultiscaleAnchorGenerator* release_multiscale_anchor_generator();
