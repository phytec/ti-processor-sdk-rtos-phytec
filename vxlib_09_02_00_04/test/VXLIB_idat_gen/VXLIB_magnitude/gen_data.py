...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "VXLIB_magnitude_idat.h"'
    ...
    idatFile.write("static VXLIB_magnitude_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    in0sqr = in0 * in0
    in1sqr = in1 * in1
    sumsqr = in0sqr + in1sqr
    # out = sumsqr
    out = np.sqrt(sumsqr)
    out = np.round(out)
    out = np.clip(out, a_min=minValOut, a_max=maxValOut)
...
idatFileName = "../../VXLIB_magnitude/VXLIB_magnitude_idat.c"
