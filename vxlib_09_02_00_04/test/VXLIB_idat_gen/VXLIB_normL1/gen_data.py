...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "VXLIB_normL1_idat.h"'
    ...
    idatFile.write("static VXLIB_normL1_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    absin0 = np.absolute(in0).astype(VXLIB_utils.resolveNumpyDType(dTypeOut))
    absin1 = np.absolute(in1).astype(VXLIB_utils.resolveNumpyDType(dTypeOut))
    absin0[absin0 >maxValIn] = maxValIn
    absin1[absin1 >maxValIn] = maxValIn
    out = absin0 + absin1
...
idatFileName = "../../VXLIB_normL1/VXLIB_normL1_idat.c"
