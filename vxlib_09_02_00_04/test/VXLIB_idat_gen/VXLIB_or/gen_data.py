...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "VXLIB_or_idat.h"'
    ...
    idatFile.write("static VXLIB_or_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
idatFileName = "../../VXLIB_or/VXLIB_or_idat.c"
