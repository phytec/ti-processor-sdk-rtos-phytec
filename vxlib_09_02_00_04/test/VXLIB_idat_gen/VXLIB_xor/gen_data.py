...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "VXLIB_xor_idat.h"'
    ...
    idatFile.write("static VXLIB_xor_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
idatFileName = "../../VXLIB_xor/VXLIB_xor_idat.c"
