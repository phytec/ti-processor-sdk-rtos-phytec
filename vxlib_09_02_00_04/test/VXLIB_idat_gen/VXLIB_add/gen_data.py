...
def gen_idat_file(idatFile, testCases):
    ...
    includeString = '#include "VXLIB_add_idat.h"'
    ...
    idatFile.write("static VXLIB_add_testParams_t testParams[] =  ")
    idatFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    if overFlowPolicy == "VXLIB_WRAP":
        out = (in0 + in1).astype(VXLIB_utils.resolveNumpyDType(dTypeOut))
...
idatFileName = "../../VXLIB_add/VXLIB_add_idat.c"
