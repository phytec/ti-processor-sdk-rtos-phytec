function(VXLIB_create_test_binary_name myKernelName)
...
function(VXLIB_create_binary_for_kernel_testing)
  ...
  vxlib_create_test_binary_name(${myKernelName})

  # message ("Exe name is ${exeName}") message ("                      ")

  # TODO: is this acceptable, hanging exeName; returned from
  # VXLIB_create_binary_extension()
  add_executable(${exeName} ${SRC_FILES})
  vxlib_set_bin_extension(${exeName})
  if(AUTO_TEST)
    target_link_libraries(${exeName} PRIVATE VXLIB VXLIB_common
                                             VXLIB_test_common ${C7x_LIBS})
  else()
    target_link_libraries(${exeName} PRIVATE "${myKernelName}_obj" "${extObjNames}" VXLIB_common
                                             VXLIB_test_common ${C7x_LIBS})
  endif()
  ...
  if(NOT AUTO_TEST)
    vxlib_add_coverage(${exeName})
    vxlib_gen_test_cases(${myKernelName})
  ...
  if(NOT TARGET_PLATFORM STREQUAL "PC")
    vxlib_set_linker_options_c7x(${exeName})
  endif()

  vxlib_finish_compilation(${exeName})
