...
MEMORY
{
  ...
  MSMC3SRAM (RWX)         : org = 0x70000100, len = 0x0fff00
  MSMC3SRAM_STATIC   (RWX): org = 0x70100000, len = 0x500000
  // MSMC3SRAM_DATACN   (RWX): org = 0x70600000, len = 0x100000
  MSMC3SRAM_PT       (RWX): org = 0x70700000, len = 0x100000
  MSMCSRAM (RWX)          : org = 0x68000000, len = 0x100000
  MSMCSRAM_DATACN    (RWX): org = 0x68100000, len = 0x200000
#else
