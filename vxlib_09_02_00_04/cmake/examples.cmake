function(VXLIB_create_example_binary_name myKernelName)
...
function(VXLIB_create_binary_for_example_kernel)
  ...
  vxlib_create_example_binary_name(${myKernelName})
  add_executable(${exeName} ${SRC_FILES})
  vxlib_set_bin_extension(${exeName})
  target_link_libraries(${exeName} PRIVATE VXLIB VXLIB_common ${C7x_LIBS})
