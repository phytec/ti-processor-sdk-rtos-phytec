...
function(VXLIB_set_lib_extension LIB_NAME)
...
function(VXLIB_create_object_lib_for_kernel)
...
# function (VXLIB_print_binary_details myBinary)
...
function(VXLIB_print_build_details)
  if(TARGET_PLATFORM STREQUAL "PC")
    message("                                          ")
    message("${BoldYellow}------------------------------------------")
...
function(VXLIB_finish_compilation exeName)
...
set(VXLIB_C7x_linker_SOC_defines
    --define=j721e=1 --define=j721s2=2 --define=j784s4=3 --define=AM62A=4
    --define=AM67A=5)
set(VXLIB_C7x_SOC_defines -D=j721e=1 -D=j721s2=2 -D=j784s4=3 -D=AM62A=4 -D=AM67A=5)
set(VXLIB_x86_SOC_defines j721e=1 j721s2=2 j784s4=3 AM62A=4 AM67A=5)
...
# set(VXLIB_C7x_compile_release_options ${foo})

function(VXLIB_compile_options)
  ...
  if(TARGET_PLATFORM STREQUAL "PC")
    ...
    add_compile_definitions(${VXLIB_x86_SOC_defines})
    add_compile_definitions(VXLIB_DEBUGPRINT=${VXLIB_DEBUGPRINT})
    ...
    add_compile_options(
      ...
      ${VXLIB_C7x_SOC_defines}
      -DVXLIB_DEBUGPRINT=${VXLIB_DEBUGPRINT}
      -DEVM_TEST
      -DSOC=${SOC}
      -D__C7X_UNSTABLE_API
      ...
      # $<$<CONFIG:RELEASE>:${VXLIB_C7x_compile_release_options}>
...
function(VXLIB_set_linker_options_C7x exeName)
  ...
  target_link_options(${exeName} PRIVATE ${VXLIB_C7x_linker_SOC_defines}
                      ${myLinkerCmd})
endfunction()

function(vxlib_include_xlib_headers)

  include_directories(BEFORE SYSTEM src/)

endfunction()

function(vxlib_set_bin_extension exeNAME)
  # message("TARGET_PLATFORM: ${TARGET_PLATFORM}, LIB_NAME:${LIB_NAME},
  # DEVICE:${DEVICE}")
  if(TARGET_PLATFORM STREQUAL "PC")
    if(CMAKE_HOST_WIN32)
