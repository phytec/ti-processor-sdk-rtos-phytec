...
typedef struct {
   ...
   uint32_t    numPoints;
   uint32_t    testID;
} ifft1d_i32fc_c32fc_o32fc_testParams_t;

void ifft1d_i32fc_c32fc_o32fc_getTestParams (
    ifft1d_i32fc_c32fc_o32fc_testParams_t **params,
    int32_t *                              numTests);

#endif /* define FFTLIB_FFT1D_I32FC_C32FC_O32FC_IDAT_H */

/* ======================================================================== */
/*  End of file:  FFTLIB_ifft1d_i32fc_c32fc_o32fc_idat.h */
/* ======================================================================== */
