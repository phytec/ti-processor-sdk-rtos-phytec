...
/* CODE_SECTION (FFTLIB_fft1d_i16sc_c16sc_o16sc_cn, ".text:ansi") */
/* CODE_SECTION (FFTLIB_fft1d_i16sc_c16sc_o16sc_checkParams_cn, ".text:ansi") */
                                   ...
                                   FFTLIB_bufParams1D_t *bufParamsShift)
{
   ...
   status = FFTLIB_fft1d_i16sc_c16sc_o16sc_checkParams_cn (
      ...
      while (numPointsPerDft > 2) {
         ...
         for (k = 0; k < numPoints / 4; k++) {
            ...
            if ((numPointsPerDft == 4) ||
               ...
               /* For this case, the twiddle factors are all 1's. In this (fixed
                * point) variant, multiplication by 1 and scaling down can
                * introduce errors. So, like in the kernel implementation, we
                * skip the multiplication by 1's                       */
               butterflyNoTw (
            ...
            /* Only one shift that is applied for 8-point and the final 2-point
             * stage combined. */
