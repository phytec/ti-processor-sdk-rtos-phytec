...
SDL_ESM_config ESM_esmInitConfig_WKUP_config =
{
...
void  esm_init(SDL_ESM_Inst esmType)
{
    ...
    result = SDL_ESM_init(esmType, &ESM_esmInitConfig_WKUP_config,SDL_ESM_applicationCallbackFunction,ptr);
...
int32_t sdl_config_WKUP(void)
{
    ...
    SDL_ESM_configInterruptHandler_WKUP((uintptr_t)config_param);
...
int32_t sdl_config_MCU(void)
{
    ...
    SDL_ESM_configInterruptHandler_MCU((uintptr_t)config_param);
    return retVal;
}
...
int32_t sdl_config_MAIN(void)
{
    ...
    SDL_ESM_configInterruptHandler_MAIN((uintptr_t)config_param);
