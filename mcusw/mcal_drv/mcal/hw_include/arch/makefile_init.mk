...
include $($(MCUSW_INSTALL_PATH))/Rules.make
...
-include $(mcal_PATH)/hw_include/arch/r5/src/startup/src_files_r5init.mk

# M4 Init Modules
-include $(PDK_CSL_COMP_PATH)/arch/m4/src/startup/src_files_m4init.mk
