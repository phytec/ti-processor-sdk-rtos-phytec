...
ifeq ($(SOC),$(filter $(SOC), j7200 j721e j721s2 am77x))
  PACKAGE_SRCS_COMMON += soc/$(SOC) soc/lldr_soc_cbass.h soc/lldr_soc_ctrl_mmr.h soc/lldr_soc_intr.h soc/lldr_soc_ecc_aggr.h
  INCDIR += ./soc
endif

ifeq ($(SOC),$(filter $(SOC), am65xx))
  PACKAGE_SRCS_COMMON += soc/$(SOC) soc/cslr_soc_cbass.h soc/cslr_soc_ctrl_mmr.h soc/cslr_soc_intr.h soc/cslr_soc_ecc_aggr.h
  INCDIR += ./soc
endif
