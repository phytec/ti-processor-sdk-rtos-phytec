 ...
 */
static volatile uint32 CSR;     /* control status register */
...
#ifdef TMS320C64PX
static volatile uint32 GPLYA;  /* GMPY Polynomial - A Side */
static volatile uint32 GPLYB;  /* GMPY Polynomial - B Side */
#endif
