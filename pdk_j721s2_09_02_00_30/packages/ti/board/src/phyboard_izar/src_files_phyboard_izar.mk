...
SRCDIR += src/phyboard_izar src/phyboard_izar/include
...
SRCS_COMMON += board_ddr.c board_info.c board_info_ddr.c board_ethernet_config.c board_utils.c board_control.c board_power.c
