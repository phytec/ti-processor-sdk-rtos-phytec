/**
* Note: This file was auto-generated by TI PinMux on 17.7.2026 at 11:32:08.
*
...
{
    /* MyWKUP_UART0 -> WKUP_UART0_CTSn -> E25 */
    {
        PIN_WKUP_GPIO0_6, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE | PIN_INPUT_ENABLE) & (~PIN_PULL_DIRECTION))
    },
    /* MyWKUP_UART0 -> WKUP_UART0_RTSn -> F28 */
    {
        PIN_WKUP_GPIO0_7, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE | PIN_INPUT_ENABLE) & (~PIN_PULL_DIRECTION))
    },
