...
drvipc_BOARDLIST       = j721e_sim j721e_qt j721e_evm j7200_evm j721s2_evm j784s4_evm phyboard_izar
...
IPC_QNX_ECHO_TESTB_MACRO_LIST := $(foreach curos, $(drvipc_RTOS_LIST) safertos, $(call IPC_QNX_ECHO_TESTB_RULE,$(curos)))
