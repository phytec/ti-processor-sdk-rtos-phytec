...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_rsqrt_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_rsqrt_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    out = np.reciprocal(np.sqrt(in0))
    if dTypeIn == "MATHLIB_FLOAT32":
        out[in0 < np.finfo(np.float32).tiny] = 0x7F800000
...
testParamsFileName = "../../MATHLIB_rsqrt/MATHLIB_rsqrt_testParams.cpp"
