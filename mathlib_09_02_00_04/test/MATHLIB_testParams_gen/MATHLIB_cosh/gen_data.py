...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_cosh_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_cosh_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    out = np.cosh(in0)
    if dTypeIn == "MATHLIB_FLOAT32":
        out[np.abs(in0) > 89.41598629] = 0x7F800000
...
testParamsFileName = "../../MATHLIB_cosh/MATHLIB_cosh_testParams.cpp"
