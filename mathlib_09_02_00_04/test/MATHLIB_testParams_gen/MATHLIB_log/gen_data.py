...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_log_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_log_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    out = np.log(in0)
    out[out > np.finfo(np.float32).max] = 709.7827
...
testParamsFileName = "../../MATHLIB_log/MATHLIB_log_testParams.cpp"
