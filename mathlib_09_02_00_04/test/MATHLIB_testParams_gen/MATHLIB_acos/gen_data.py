...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_acos_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_acos_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    if dTypeIn == "MATHLIB_FLOAT32":
        ...
        in0 = np.linspace(-1, 1, length).astype("float")
...
testParamsFileName = "../../MATHLIB_acos/MATHLIB_acos_testParams.cpp"
