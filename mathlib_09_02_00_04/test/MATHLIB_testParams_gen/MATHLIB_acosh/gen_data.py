...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_acosh_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_acosh_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    out = np.arccosh(in0)
    if dTypeIn == "MATHLIB_FLOAT32":
        out[in0 > np.finfo(np.float32).max] = 89.41599
        out[in0 <= 1.0] = 0x7FFFFFFF
...
testParamsFileName = "../../MATHLIB_acosh/MATHLIB_acosh_testParams.cpp"
