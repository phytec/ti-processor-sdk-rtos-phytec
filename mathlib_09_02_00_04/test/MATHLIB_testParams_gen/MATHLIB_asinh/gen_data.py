...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_asinh_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_asinh_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    if dTypeIn == "MATHLIB_FLOAT32":
        ...
        in0 = np.linspace(-1000, 1000, length).astype("float")

        """ Edge Case for outside arcsine domain """
        ...
        in0 = np.linspace(-1, 1, length).astype("double")
...
testParamsFileName = "../../MATHLIB_asinh/MATHLIB_asinh_testParams.cpp"
