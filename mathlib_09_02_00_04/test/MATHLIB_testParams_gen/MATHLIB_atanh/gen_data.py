...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_atanh_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_atanh_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    out = np.arctanh(in0)
    if dTypeIn == "MATHLIB_FLOAT32":
        out[np.absolute(in0) == 1] = 0x7F800000
...
testParamsFileName = "../../MATHLIB_atanh/MATHLIB_atanh_testParams.cpp"
