...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_sqrt_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_sqrt_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    if dTypeIn == "MATHLIB_FLOAT32":
        in0 = np.linspace(0, 100, length).astype("float")
    else:
        in0 = np.linspace(0, 100, length).astype("double")
...
testParamsFileName = "../../MATHLIB_sqrt/MATHLIB_sqrt_testParams.cpp"
