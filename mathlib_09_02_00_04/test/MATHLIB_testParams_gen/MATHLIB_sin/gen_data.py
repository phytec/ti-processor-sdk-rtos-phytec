...
def gen_idat_file(testParamsFile, testCases):
    ...
    includeString = '#include "MATHLIB_sin_testParams.h"'
    ...
    testParamsFile.write("static MATHLIB_sin_testParams_t testParams[] =  ")
    testParamsFile.write("{\n")
...
def gen_test_case_header_file(testCase):
    ...
    if dTypeIn == "MATHLIB_FLOAT32":
        in0 = np.linspace(0, 2 * np.pi, length).astype("float")
    else:
        in0 = np.linspace(0, 2 * np.pi, length).astype("double")
...
testParamsFileName = "../../MATHLIB_sin/MATHLIB_sin_testParams.cpp"
