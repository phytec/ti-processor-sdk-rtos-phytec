...
$(_MODULE)_COPT += --opt_level=3 --gen_opt_info=2 --symdebug:none
endif
...
ifeq ($(DUMP_DATA),1)
$(_MODULE)_DEFS += _VXLIB_DUMP_DATA
endif

ifeq ($(QT_BUILD),1)
$(_MODULE)_DEFS += _QT_BUILD
$(_MODULE)_DEFS += _VXLIB_READ_STATIC_DATA
endif
...
$(_MODULE)_LDFLAGS  := $($(_MODULE)_CFLAGS) -z $($(_MODULE)_LDEFINES) --zero_init=off --warn_sections --reread_libs --rom_model
