...
all-asm-files  = $(call all-type-files,*.asm)
all-S-files    = $(call all-type-files,*.S)
all-k-files    = $(call all-type-files,*.k)
...
all-asm-files-in  = $(call all-type-files-in,*.asm,$(1))
all-S-files-in    = $(call all-type-files-in,*.S,$(1))
all-k-files-in    = $(call all-type-files-in,*.k,$(1))
