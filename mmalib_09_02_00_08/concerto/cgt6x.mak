...
$(_MODULE)_COPT := --abi=eabi --mem_model:data=far --display_error_number --emit_warnings_as_errors --diag_remark=10068 --use_g2
...
$(_MODULE)_COPT += -o3 --opt_level=3 --gen_opt_info=2 --symdebug:none
endif

ifeq ($(TARGET_CPU),C64T)
$(_MODULE)_COPT += -mvtesla --silicon_version=tesla -D=xdc_target_name=C64T
else ifeq ($(TARGET_CPU),C64P)
$(_MODULE)_COPT += -mv6400+ --silicon_version=6400+ -D=xdc_target_name=C64P
else ifeq ($(TARGET_CPU),C64)
$(_MODULE)_COPT += -mv6400 --silicon_version=6400 -D=xdc_target_name=C64
else ifeq ($(TARGET_CPU),C66)
$(_MODULE)_COPT += -mv6600 --silicon_version=6600 -D=xdc_target_name=C66
else ifeq ($(TARGET_CPU),C674)
$(_MODULE)_COPT += -mv6740 --silicon_version=6740 -D=xdc_target_name=C674
else ifeq ($(TARGET_CPU),C67)
$(_MODULE)_COPT += -mv6700 --silicon_version=6700 -D=xdc_target_name=C67
else ifeq ($(TARGET_CPU),C67P)
$(_MODULE)_COPT += -mv6700+ --silicon_version=6700+ -D=xdc_target_name=C67P
endif
...
$(_MODULE)_LDFLAGS  := $($(_MODULE)_CFLAGS) -z $($(_MODULE)_LDEFINES) --warn_sections --reread_libs --rom_model
