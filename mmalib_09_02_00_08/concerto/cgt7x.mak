...
$(_MODULE)_COPT += --opt_level=3 --gen_opt_info=2 --symdebug:none -os -mw --disable:NLC --auto_inline --gen_func_subsections
endif
...
$(_MODULE)_COPT += --silicon_version=7120
$(_MODULE)_COPT += -D__C7X_UNSTABLE_API
$(_MODULE)_AOPT += --silicon_version=7120
...
else ifeq ($(TEST_ENV), VMIN)
$(_MODULE)_COPT += -mo=on
$(_MODULE)_DEFS += EVM_TEST
$(_MODULE)_DEFS += VMIN_DDR_MEMORY_RANGE
endif
