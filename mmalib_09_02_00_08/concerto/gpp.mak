...
$(_MODULE)_COPT += -Wall -fms-extensions -Wno-write-strings -Wno-unknown-pragmas

ifeq ($(TARGET_BUILD),debug)
$(_MODULE)_COPT += -O0 -g -gdwarf-2
#$(_MODULE)_LOPT += -g
...
$(_MODULE)_DEFS += RESERVED=6
$(_MODULE)_DEFS += RESERVED=7
ifeq ($(SOC),J7ES)
...
$(ODIR)/%.o: $(SDIR)/%.c
	...
	$(Q)$(CP) --std=c++14 $($(_MODULE)_CFLAGS) -MMD -MF $(ODIR)/$$*.dep -MT '$(ODIR)/$$*.o' $$< -o $$@ $(LOGGING)
