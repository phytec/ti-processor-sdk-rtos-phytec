...
/**
******************************************************************************
*  @file     MMALIB_CNN_convolve_col_smallNo_highPrecision_idat.h
*
...
#ifndef MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_IDAT_H_
#define MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_IDAT_H_
...
typedef struct {
   ...
   int32_t numReps;
   uint32_t testID;
} MMALIB_CNN_convolve_col_smallNo_highPrecision_testParams_t;
...
#endif /* define MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_IDAT_H_ */

/* ======================================================================== */
/*  End of file:  MMALIB_CNN_convolve_col_smallNo_highPrecision_idat.h                */
/* ======================================================================== */
