...
*
*  @brief    Public header file for MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights
*            function
*
...
#ifndef MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_REORDERWEIGHTS_H_
#define MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_REORDERWEIGHTS_H_

#include "../../common/MMALIB_types.h"
#include "../MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost/MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights.h"
...
/*!
 * @defgroup MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights
 *
 * @brief
 *        @ref MMALIB_CNN_convolve_col_smallNo_highPrecision requires that the weights be preprocessed into
...
\endcode
 *
 * @ingroup  MMALIB_CNN_convolve_col_smallNo_highPrecision
 */
/**@{**/

   
   /**
    *  @enum       MMALIB_reorder_weights_highPrecision_operation_e
    *  @brief      Enumeration for different operations for the reorderWeights function
    *
    */
   typedef enum _MMALIB_reorder_weights_highPrecision_operation_e
   {
   ...
   /*!
    *******************************************************************************
    @struct MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_Args
...
// alias
typedef MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_Args MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_Args;
    ...
    *               @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_Args
    *               structure.
    *
    *  @param [in]  pArgs                    :  Pointer to the structure containing the required dimensional information
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_fillBufParams(const MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_Args *pArgs,
    ...
    *               with pBias == NULL.
    *
    *  @param [in]  operation     : Desired reordering configuration, arguments are of type @ref MMALIB_reorder_weights_highPrecision_operation_e
    *                                 HIGHPRECISION_REORDERWEIGHTS_AND_BIAS = reorder weights and bias values simultaneously
    *                                 HIGHPRECISION_REORDERWEIGHTS = reorder weights, leaving space for bias values to be added later
    *                                 HIGHPRECISION_REORDERBIAS = assume weights are already present, add-in bias values
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_exec(uint32_t operation,
                                                                                 const MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_Args *pArgs,
...
#endif
#endif /* MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_REORDERWEIGHTS_H_ */

/* ============================================================================ */
/*  End of file:  MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights.h  */
/* ============================================================================ */
