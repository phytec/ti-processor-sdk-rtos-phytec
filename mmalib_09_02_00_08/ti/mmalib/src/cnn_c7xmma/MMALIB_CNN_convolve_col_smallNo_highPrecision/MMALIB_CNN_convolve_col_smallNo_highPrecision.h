...
extern "C" {
   ...
   /*!
    *******************************************************************************
    * @defgroup MMALIB_CNN_convolve_col_smallNo_highPrecision MMALIB_CNN_convolve_col_smallNo_highPrecision
    * @brief NOTE: This API is now a wrapper to @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost
    *        with the lutValues input argument set to NULL.  It is recommended to call @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost directly.
    * 
    *        Kernel for computing CNN-style 2D convolution using column major
    ...
    *        @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights to generate this reordering (src0) and the
...
#define MMALIB_CONVOLVE_COL_SHIFT_SINGLE 0      //!< Use the same shift value for all groups in calls to @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_exec
#define MMALIB_CONVOLVE_COL_SHIFT_PER_GROUP 1   //!< [Future feature, no yet supported] Use the unique shift value for each group in calls to @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_exec
...
//      int8_t    shiftMethod;    //!< Control behavior of MMALIB_CNN_convolve_col_smallNo_highPrecision_InitArgs.shift.  @ref MMALIB_CONVOLVE_COL_SHIFT_SINGLE is currently the only supported value.
...
//   } MMALIB_CNN_convolve_col_smallNo_highPrecision_ExecOutArgs ;
    ...
    *                               @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_fillBufParams
...
MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_highPrecision_init_checkParams(MMALIB_kernelHandle handle,
    ...
    *                             @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_reorderWeights_exec.
    *                             [ A matrix]
