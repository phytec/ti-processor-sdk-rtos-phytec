...
/********************************************************************************
*  @file     MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights.h
*
*  @brief    Public header file for MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights
*            function
*
...
#ifndef MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_REORDERWEIGHTS_H_
#define MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_REORDERWEIGHTS_H_
...
/*!
 * @defgroup MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights
 *
 * @brief
 *        @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost requires that the weights be preprocessed into
...
\endcode
 *
 * @ingroup  MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost
 */
/**@{**/

   
   /**
    *  @enum       MMALIB_reorder_weights_highPrecision_pointwisePost_operation_e
    *  @brief      Enumeration for different operations for the reorderWeights function
    *
    */
   typedef enum _MMALIB_reorder_weights_highPrecision_pointwisePost_operation_e
   {
   ...
   typedef struct
   {
      ...
      int32_t rightPad;           //!< Pixels of pad to apply to the rights side of the input data
   ...
   } MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_Args ;
    ...
    *               @ref MMALIB_CNN_convolve_col_smallNo_highPrecision
    *
    ...
    *               @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_Args
    *               structure.
    *
    *  @param [in]  pArgs                    :  Pointer to the structure containing the required dimensional information
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_fillBufParams(const MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_Args *pArgs,
                                                                                          MMALIB_bufParams3D_t *pReorderedWeights_addr);
    ...
    *               with pBias == NULL.
    *
    *  @param [in]  operation     : Desired reordering configuration, arguments are of type @ref MMALIB_reorder_weights_highPrecision_pointwisePost_operation_e
    *                                 HIGHPRECISION_POINTWISEPOST_REORDERWEIGHTS_AND_BIAS = reorder weights and bias values simultaneously
    *                                 HIGHPRECISION_POINTWISEPOST_REORDERWEIGHTS = reorder weights, leaving space for bias values to be added later
    *                                 HIGHPRECISION_POINTWISEPOST_REORDERBIAS = assume weights are already present, add-in bias values
    ...
    *
    *  @par Assumptions:
    *    - pBias == NULL if the bias values are already stored with weights in pWeights in HIGHPRECISION_POINTWISEPOST_REORDERWEIGHTS_AND_BIAS mode
    *
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_exec(uint32_t operation,
                                                                                 const MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_Args *pArgs,
                                                                                 const MMALIB_bufParams3D_t *pWeights_addr,
                                                                                 ...
                                                                                 const MMALIB_bufParams3D_t *pReorderedWeights_addr,
...
#endif
#endif /* MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_REORDERWEIGHTS_H_ */

/* ============================================================================ */
/*  End of file:  MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights.h  */
/* ============================================================================ */
