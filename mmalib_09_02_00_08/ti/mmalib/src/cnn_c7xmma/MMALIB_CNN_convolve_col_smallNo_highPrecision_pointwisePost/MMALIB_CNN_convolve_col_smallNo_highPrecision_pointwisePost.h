...
/********************************************************************************
 *  @file     MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost.h
 *
 *  @brief    Public header file for MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost
 *            function
 *
...
#ifndef MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_H_
#define MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_H_

#include "../../common/MMALIB_types.h"
#include "MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights.h"
...
extern "C" {
   ...
   /*!
    *******************************************************************************
    * @defgroup MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost
    ...
    *        @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights to generate this reordering (src0) and the
...
/**@{**/
   ...
   /*!
    *******************************************************************************
    *  @enum       MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_STATUS_NAME
    *  @brief      Enumeration for different error codes for MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost kernel
    *******************************************************************************
    */

   typedef enum
   {
      MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_ERR_SMALL_K  = MMALIB_ERROR_MAX, /** Error case because k < Ni*Fr*Fc */
...
#define MMALIB_CONVOLVE_COL_SHIFT_SINGLE 0      //!< Use the same shift value for all groups in calls to @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_exec
#define MMALIB_CONVOLVE_COL_SHIFT_PER_GROUP 1   //!< [Future feature, no yet supported] Use the unique shift value for each group in calls to @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_exec
   ...
   typedef struct
   {
      ...
      int8_t    shiftMethod;    //!< Control behavior of MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_InitArgs.shift.  @ref MMALIB_CONVOLVE_COL_SHIFT_SINGLE is currently the only supported value.
   ...
   } MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_InitArgs ;
   ...
   } MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_ExecInArgs ;
   ...
   typedef struct
   {
      ...
      int64_t dynamicRangeMin;      //!< Minimum computed value, controlled with MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_ExecInArgs.initDynamicRange
      int64_t dynamicRangeMax;      //!< Maximum computed value, controlled with MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_ExecInArgs.initDynamicRange
    ...
    *                               @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_fillBufParams
...
MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_init_checkParams(MMALIB_kernelHandle handle,
    ...
    *                             @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_exec.
    *                             [ A matrix]
    *  @param [in]  src1[]      : Pointer to buffer holding input feature map data.
    *                             [ B matrix]
    *  @param [in]  src2[]      : Pointer to buffer holding bias data
    *  @param [in]  src3[]      : Pointer to buffer holding scale values
    *  @param [in]  shiftValues[] : Pointer to buffer of shift values to apply results prior to output.
    *                              Set to NULL if using @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_InitArgs.shiftMethod = @ref MMALIB_CONVOLVE_COL_SHIFT_SINGLE, which is currently the only supported option.
    *                              [Future development] Set to numGroupsPerKernel if using @ref MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_InitArgs.shiftMethod = @ref MMALIB_CONVOLVE_COL_SHIFT_PER_GROUP.
    *  @param [in]  lutValues[] : Pointer to buffer of lookup table values; set to NULL if lookup table not used
    ...
    *                               information of src1
    *  @param [in]  src2_addr    :  Pointer to buffer holding bias data
    *  @param [in]  src3_addr    :  Pointer to structure containing dimensional
    *                               information of src3 (scale)
...
#endif
#endif /* MMALIB_CNN_CONVOLVE_COL_SMALLNO_HIGHPRECISION_POINTWISEPOST_H_ */

/* ============================================================================= */
/*  End of file:  MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost.h  */
/* ============================================================================= */
