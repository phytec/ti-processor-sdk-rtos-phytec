...
/********************************************************************************
 *  @file     MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_d.c
 *
...
void MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_generateRandomKernels(void **pKernels,
...
int MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_d(uint32_t *pProfile, uint8_t LevelOfFeedback)
{
   ...
   /* Test Parameters */
   MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_testParams_t *prm;
   MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_testParams_t currPrm;
   MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_getTestParams(&prm, &test_cases);
   
   MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_InitArgs    kerInitArgs;
   MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_ExecInArgs  kerExecInArgs;
   MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_ExecOutArgs kerExecOutArgs_ci;
   MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_ExecOutArgs kerExecOutArgs_cn;

   currPrm.expectedStatusCode = MMALIB_SUCCESS;
   ...
   for ( tpi = 0; tpi < test_cases; tpi++ ) {
      ...
      int32_t handleSize = MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_getHandleSize(&kerInitArgs);
      ...
      for(repCount = 0; repCount < numReps; repCount++){
         ...
         uint32_t inp0Size, inp1Size, inp2Size, inp3Size, inp4Size, inp5Size, outSize;
         ...
         MMALIB_bufParams1D_t src5_addr;                // ILUT values
         ...
         MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_Args reorderWeightsArgs;
         ...
         inp0Size = MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_getMemorySize(&reorderWeightsArgs);
                 
         // fill the bufParams for src0
         MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_fillBufParams(&reorderWeightsArgs, &src0_addr);
         ...
         src5_addr.dim_x                = MMALIB_ILUT_NUM_BYTES;       
         src5_addr.data_type            = dataTypeC; // really unsigned, but using this for bit width
         inp5Size                       = src5_addr.dim_x * MMALIB_sizeof(src5_addr.data_type);
         ...
         uint8_t *src5    = (uint8_t *) TI_memalign(MMALIB_ALIGN_128BYTES, inp5Size);  // LUT
            ...
            (src0 && src1 && dst && dst_cn)
         {
            ...
            if( currPrm.staticKernel != NULL ) {
               ...
               MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_exec(HIGHPRECISION_REORDERWEIGHTS, &reorderWeightsArgs, &weights_addr, currPrm.staticKernel, NULL, NULL, &src0_addr, src0);
               ...
               MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_generateRandomKernels(&normalOrderKernels, &weights_addr, &kerInitArgs);
               
               // random data for kernel coefficients and bias
               MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_reorderWeights_exec(HIGHPRECISION_REORDERWEIGHTS, &reorderWeightsArgs, &weights_addr, normalOrderKernels, NULL, NULL, &src0_addr, src0);
            ...
            // copy/generate the ILUT vector
            if (currPrm.staticILUT != NULL){
               TI_fillBuffer(shiftPattern,
                          (uint8_t)4,
                          src5, currPrm.staticILUT,
                          src5_addr.dim_x, 1, 0,
                          MMALIB_sizeof(src5_addr.data_type), testPatternString);
            } else {
               src5 = NULL;
            }
            ...
            currTestStatus = MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_init(handle,
                                                                                 &src0_addr,
                                                                                 &src1_addr,
                                                                                 &src2_addr,
                                                                                 &src3_addr,
            ...
            if(currTestStatus == MMALIB_SUCCESS){
               ...
               currTestStatus = MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_exec(handle, src0, pSrc1, src2, src3, src4, src5, dst,
                                                                                    &kerExecInArgs,
                                                                                    &kerExecOutArgs_ci);
               MMALIB_asm(" MARK 3");
               TI_profile_stop();
            ...
            if(currTestStatus == MMALIB_SUCCESS)
            {
               ...
               MMALIB_asm(" MARK 4");
               currTestStatus = MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_exec(handle,
                                                                                    src0,
                                                                                    pSrc1,
                                                                                    src2,
                                                                                    src3,
            ...
            if(currTestStatus == MMALIB_SUCCESS)
            {
               ...
               MMALIB_PRINTF("MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_init_checkParams failed with status = %d!\n", currTestStatus);
            }
            ...
            if( currPrm.staticOut != NULL ) {
               ...
               if(currPrm.enableDynamicRange == MMALIB_DYNAMIC_RANGE_ENABLE){
                  ...
                  if(currPrm.enableDynamicRange == MMALIB_DYNAMIC_RANGE_ENABLE){
                     ...
                     MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_perfEst(handle,
                           &src0_addr,
                           &src1_addr,
                           &src2_addr,
                           &src3_addr,
         ...
         int test_main(uint32_t *pProfile) {
            ...
            {
               return  MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_d(pProfile, 0);
            }
         }
         ...
         /* ======================================================================== */
         /*  End of file:  MMALIB_CNN_convolve_col_smallNo_highPrecision_pointwisePost_d.c           */
         /* ======================================================================== */
