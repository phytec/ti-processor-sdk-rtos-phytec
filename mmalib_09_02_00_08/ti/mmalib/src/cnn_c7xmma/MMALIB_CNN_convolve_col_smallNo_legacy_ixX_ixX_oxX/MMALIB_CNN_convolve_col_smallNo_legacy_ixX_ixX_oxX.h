...
/********************************************************************************
 *  @file     MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX.h
 *
 *  @brief    Public header file for MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX
 *            function
 *
...
#ifndef MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_H_
#define MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_H_

#include "../../common/MMALIB_types.h"
#include "MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights.h"
...
extern "C" {
   ...
   /*!
    *******************************************************************************
    * @defgroup MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX
    * @brief [DEPRECATED] Kernel for computing CNN-style 2D convolution using column major
    ...
    *        THIS KERNEL EXISTS TO EASE TRANSITION OF CODE FROM C7100 TO C7120 AND IMPLEMENTS THE SAME ALGORITHM AS WAS USED IN C7100 ON C7120.
    *        HOWEVER, THIS IS NOT THE MOST EFFICIENT USE OF C7120 AND IT IS RECOMMENDED TO USE @ref MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX
    *        OR @ref MMALIB_CNN_convolve_col_smallNo_highPrecision AS APPROPRIATE. This kernel will be removed in future releases.
    * @details
    ...
    *
    *        This kernels differs from  @ref MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX in that it requires all padding to be performed before
    *        the input feature maps are passed to the kernel whereas  @ref MMALIB_CNN_convolve_col_smallNo_ixX_ixX_oxX can pad input feature maps
    *        internally.
    *
    ...
    *        constant across all groups called at the same time.
    ...
    *             -- i.e. pKerInitArgs->blockFeatureHeight % 2 == 0
    ...
    *        @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights to generate this reordering (src0) and the
   ...
   /*!
    *******************************************************************************
    *  @enum       MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_STATUS_NAME
   ...
   typedef enum
   {
      MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_ERR_SMALL_K  = MMALIB_ERROR_MAX, /** Error case because k < Ni*Fr*Fc */
      /* @todo Add more appropriate error codes */
      MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_ERR_MAX
   } MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_STATUS_NAME ;

#define MMALIB_CONVOLVE_COL_SHIFT_SINGLE 0      //!< Use the same shift value for all groups in calls to @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_exec
#define MMALIB_CONVOLVE_COL_SHIFT_PER_GROUP 1   //!< Use the unique shift value for each group in calls to @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_exec

   /*!
    *******************************************************************************
    * @struct MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs
   ...
   typedef struct
   {
      ...
      int8_t    shiftMethod;    //!< Control behavior of MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs.shift
   ...
   } MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs ;


   /*!
    *******************************************************************************
    * @struct MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecInArgs
   ...
   } MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecInArgs ;


   /*!
    *******************************************************************************
    * @struct MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecOutArgs
   ...
   } MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecOutArgs ;
   ...
   int32_t MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_getHandleSize(MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs *pKerInitArgs);
    ...
    *                               @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_fillBufParams
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_init(MMALIB_kernelHandle handle,
								  const MMALIB_bufParams2D_t * src0_addr,
								  const MMALIB_bufParams2D_t * src1_addr,
								  const MMALIB_bufParams3D_t * dst_addr ,
								  const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs *pKerInitArgs);
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_init_checkParams(MMALIB_kernelHandle handle,
									      const MMALIB_bufParams2D_t * src0_addr,
									      const MMALIB_bufParams2D_t * src1_addr,
									      const MMALIB_bufParams3D_t * dst_addr,
									      const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs *pKerInitArgs);
    ...
    *                             @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_exec
    *                             [ A matrix]
    ...
    *                              Set to NULL if using @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs.shiftMethod = @ref MMALIB_CONVOLVE_COL_SHIFT_SINGLE,
    *                              or numGroupsPerKernel long if using @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs.shiftMethod = @ref MMALIB_CONVOLVE_COL_SHIFT_PER_GROUP.
    *  @param [in]  biasBValues[] : Pointer to buffer of bias values to load into the MMA B matrix
    *                              Set to NULL if using @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs.shiftMethod = @ref MMALIB_CONVOLVE_COL_SHIFT_SINGLE,
    *                              or numGroupsPerKernel long if using @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs.shiftMethod = @ref MMALIB_CONVOLVE_COL_SHIFT_PER_GROUP.
    *                              @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs.numBiasVals must == 1 for @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs.shiftMethod = @ref MMALIB_CONVOLVE_COL_SHIFT_PER_GROUP
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_exec(MMALIB_kernelHandle handle,
                                                                  const void *src0,
                                                                  const void *src1,
                                                                  const uint8_t *shiftValues,
                                                                  const int32_t *biasBValues,
                                                                  void *restrict dst,
                                                                  const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecInArgs *pKerInArgs,
                                                                  MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecOutArgs *pKerOutArgs);
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_exec_checkParams(MMALIB_kernelHandle handle,
                                                                              const void *src0,
                                                                              const void *src1,
                                                                              const uint8_t *shiftValues,
                                                                              const int32_t *biasBValues,
   ...
   void MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_perfEst( MMALIB_kernelHandle handle,
                                                            const MMALIB_bufParams2D_t * src0_addr,
                                                            const MMALIB_bufParams2D_t * src1_addr,
                                                            const MMALIB_bufParams3D_t * dst_addr,
                                                            const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_InitArgs *pKerInitArgs,
                                                            const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecInArgs *pExecInArgs,
                                                            MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_ExecOutArgs *pExecOutArgs,
...
#endif
#endif /* MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_H_ */

/* ======================================================================== */
/*  End of file:  MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX.h                     */
/* ======================================================================== */
