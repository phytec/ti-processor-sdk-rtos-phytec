...
/********************************************************************************
*  @file     MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights.h
*
*  @brief    Public header file for MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights
*            function
*
...
#ifndef MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_REORDERWEIGHTS_H_
#define MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_REORDERWEIGHTS_H_
...
/*!
 * @defgroup MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights
 *
 * @brief
 *        @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX requires that the weights be preprocessed into
...
\endcode
 *
 * @ingroup  MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX
 */
/**@{*/

   
   /**
    *  @enum       MMALIB_reorder_weights_legacy_operation_e
    *  @brief      Enumeration for different operations for the reorderWeights function
    *
    */
   typedef enum _MMALIB_reorder_weights_legacy_operation_e
   {
      LEGACY_REORDER_WEIGHTS_AND_BIAS,
      LEGACY_REORDER_WEIGHTS,
      LEGACY_REORDER_BIAS,
   } MMALIB_reorder_weights_legacy_operation_e;

  
   /*!
    *******************************************************************************
    @struct MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_Args
   ...
   } MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_Args ;
    ...
    *               @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX
    *
   ...
   int32_t MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_getMemorySize(const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_Args *pArgs);
    ...
    *               @ref MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_Args
    *               structure.
    *
    *  @param [in]  pArgs                    :  Pointer to the structure containing the required dimensional information
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_fillBufParams(const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_Args *pArgs,
    ...
    *               with pBias == NULL.
    *
    *  @param [in]  operation     : Desired reordering configuration, arguments are of type @ref MMALIB_reorder_weights_legacy_operation_e
    *                                 LEGACY_REORDER_WEIGHTS_AND_BIAS = reorder weights and bias values simultaneously
    *                                 LEGACY_REORDER_WEIGHTS = reorder weights, leaving space for bias values to be added later
    *                                 LEGACY_REORDER_BIAS = assume weights are already present, add-in bias values
    ...
    *
    *  @par Assumptions:
    *    - pBias == NULL if the bias values are already stored with weights in pWeights in LEGACY_REORDER_WEIGHTS_AND_BIAS mode
    *
   ...
   MMALIB_STATUS MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_exec(uint32_t operation,
                                                                                 const MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights_Args *pArgs,
...
#endif
#endif /* MMALIB_CNN_CONVOLVE_COL_SMALLNO_LEGACY_IXX_IXX_OXX_REORDERWEIGHTS_H_ */

/* ============================================================================ */
/*  End of file:  MMALIB_CNN_convolve_col_smallNo_legacy_ixX_ixX_oxX_reorderWeights.h  */
/* ============================================================================ */
